...
\begin{itemize}
  ...
  \item \emph{Popular network stack} : <++>
    ...
    % documentation, etc.
    \marginpar{proprietary, vendor-specific : bad (if chip maker drops support,
    we're doomed. ZigBee is okay because it's widespread, but licensing costs
    money. MiWi and others are nice protocols, but not interoperable. Also not
...
\marginpar{re-arrange these two paragraphs to make them more coherent}
